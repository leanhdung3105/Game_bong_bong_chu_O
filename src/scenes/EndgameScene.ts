...
export default class EndGameScene extends Phaser.Scene {
    ...
    preload() {
        this.load.image(
            'banner_congrat',
            'assets/images/popup_win.webp'
        );
        this.load.image('btn_reset', 'assets/images/btn_replay.webp');
    ...
    create() {
        ...
        (this.scene.get('GameScene') as unknown as { stopAllVoices?: () => void })?.stopAllVoices?.();
        ...
        replayBtn.on('pointerdown', () => {
            ...
            const compare = this.scene.get('GameScene') as unknown as { stopAllVoices?: () => void };
            ...
            this.scene.start('GameScene'); // CompareScene sẽ tự random level lại
        });
